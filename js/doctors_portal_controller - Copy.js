...
if(document.getElementById("follow-tab-classic").classList.contains("v_lower_pane_active")){
    document.getElementById("follow-tab-classic").classList.remove("v_lower_pane_active");
}
if(document.getElementById("contact-tab-classic").classList.contains("v_lower_pane_active")){
    document.getElementById("contact-tab-classic").classList.remove("v_lower_pane_active");
}
...
document.getElementById("profile-tab-classic").classList.add("v_lower_pane_active");
...
function tab_pane2ClickAction (){
    ...
    if(document.getElementById("profile-tab-classic").classList.contains("v_lower_pane_active")){
        document.getElementById("profile-tab-classic").classList.remove("v_lower_pane_active");
    }
    document.getElementById("follow-tab-classic").classList.add("v_lower_pane_active");
    document.getElementById("contact-tab-classic").classList.add("v_text_whiteFF");
    ...
    function tab_pane3ClickAction (){
        ...
        document.getElementById("contact-tab-classic").classList.add("v_lower_pane_active");
        document.getElementById("follow-tab-classic").classList.add("v_text_whiteFF");
    document.getElementById("profile-tab-classic").classList.add("v_text_whiteFF");
    $.fn.bottom_dispense_pane_up();
        }
...
function set_patients_main_fragment(id,assignID){
  ...
  function (result){
    ...
    get_patient_d_f_static_vars(result.usrID);
...
function get_patient_d_f_static_vars(id){
...
$.get("http://localhost:3130/get_prof_and_institu_name",{
  ...
  static_data.docName = result.fullName;
...
$.fn.getLatest_Note = function(){
  ...
  function (result_id){
    var startDate = moment().subtract(174,'days');
var endDate = moment();
$.get('http://localhost:3130/get_latest_Ecounter_Note',{
range1:startDate.format('MM/DD/YYYY'),
range2:endDate.format('MM/DD/YYYY'),
usrID:result_id.usrID
},
...
$.get('http://localhost:3130/get_Ecounter_Note_with_id',{
DocID:DocID
},
function (result){
getE("note_disp_div_loaderDDH").style.display = "none";
...
$.fn.getNoteSelectwithDate_dpr = function(){
  ...
  function (result_id){
    $.get('http://localhost:3130/get_disp_Ecounter_Note_dateTime',{
usrID:result_id.usrID
},
function (result){
result.forEach(e => {
